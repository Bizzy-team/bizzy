...
module.exports = async (cookie, options = {checkToken: true, returnBool: false, JWT: ""}) => {
    if (!cookie || typeof cookie !== "string") {
        options && options.returnBool && false
    ...
    if (options.checkToken) {
        return verify(options.JWT, user.verifyJWTToken, async function (err) {
            if (err) {
                ...
                if (err.name === "TokenExpiredError") {
                    ...
                    options && options.returnBool && true;
