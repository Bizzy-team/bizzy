                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#5FBF73" style="border-radius: 6px;">
                          <a href="http://localhost:3000/reset_pswd_form?token=13123" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset My Password</a>
                        </td>
                      </tr>
                    </table>
                  </td>
...
`
    ...
    return Promise.resolve({
      code: 200,
      data: {
        message: `Mail send to ${data.mail}`
      }
    });
  });
